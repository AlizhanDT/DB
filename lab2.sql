...
values (1,'Daulet','Alizhan','Wolohova st','Almaty',101);

update student
set fname = 'John', lname = 'Doe'  -- update
where id = 1;
...
values ('Alizhan','Wolohova st, Almaty');

update customers
set full_name = 'John'  -- update
where delivery_address = 'Wolohova, Almaty';
